...
Java_com_tengine_openailab_application_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
JNIEXPORT jint JNICALL
Java_com_tengine_openailab_application_MainActivity_TengineWrapperRelease(
        JNIEnv *env,
        jobject /* this */) {
...
JNIEXPORT jint JNICALL
Java_com_tengine_openailab_application_MainActivity_RunMobilenet(
        JNIEnv *env,
...
JNIEXPORT jstring JNICALL
Java_com_tengine_openailab_application_MainActivity_TengineWrapperGetTop1(
        JNIEnv *env,
        jobject /* this */) {
